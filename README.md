...
- Certains articles ne retournent ni valeur pour la balise `idrefs` ni prénom, ni nom de famille. Ces deux dernières informations sont pourtant présentes dans les fichiers XML. C'est par exemple le cas de l'article [1118513ar](https://www.erudit.org/fr/revues/archivaria/2025-n99-archivaria010099/1118513ar.xml), seulement pour la cinquième autrice (Karen Suurtamm) ou de l'article [1117727ar](https://www.erudit.org/fr/revues/possibles/2025-v49-n1-possibles010004/1117727ar.xml). Le problème semble être lié à l'absence d'une balise `idrefs` dans `notebio` : ces dernières sont alors seulement identifiées par une balise `id`. Il faudrait trouver un moyen de contourner le problème en extrayant aussi les prénoms et noms de famille même si la balise `idrefs` est absente. Le vol. 49 n°1 (printemps 2025) de la revue _Possibles_ semble particulièrement concerné.
